    ...
    public partial class ModbusClient
    {
        ...
        public bool[] ReadDiscreteInputs(int startingAddress, int quantity)
        {
            ...
            if (data[7] == 0x82 & data[8] == 0x02)
            {
                ...
                throw new EasyModbus.Exceptions.StartingAddressInvalidException("Starting address invalid or starting address + quantity invalid, starting address: " + startingAddress.ToString() + ", quantity: " + quantity.ToString());
            }
        ...
        public void WriteSingleCoil(int startingAddress, bool value)
        {
            ...
            {
                if (debug) StoreLogData.Instance.Store("StartingAddressInvalidException Throwed", System.DateTime.Now);
                throw new EasyModbus.Exceptions.StartingAddressInvalidException("Starting address invalid or starting address + quantity invalid, starting address: " + startingAddress.ToString() + ", quantity: " + 1.ToString());
            }
        ...
        public void WriteMultipleCoils(int startingAddress, bool[] values)
        {
            ...
            {
                if (debug) StoreLogData.Instance.Store("StartingAddressInvalidException Throwed", System.DateTime.Now);
                throw new EasyModbus.Exceptions.StartingAddressInvalidException("Starting address invalid or starting address + quantity invalid, starting address: " + startingAddress.ToString() + ", quantity: " + values.Length.ToString());
            }
        ...
        public int[] ReadWriteMultipleRegisters(int startingAddressRead, int quantityRead, int startingAddressWrite, int[] values)
        {
            ...
            {
                if (debug) StoreLogData.Instance.Store("StartingAddressInvalidException Throwed", System.DateTime.Now);
                throw new EasyModbus.Exceptions.StartingAddressInvalidException("Starting address invalid or starting address + quantity invalid, starting address: " + startingAddressRead.ToString() + ", quantity: " + quantityRead.ToString());
            }
